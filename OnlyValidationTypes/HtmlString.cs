...
/// <summary>
/// Thin wrapper around a string that ensures it is valid HTML.
/// </summary>
[Serializable]
...
public partial record HtmlString : NonEmptyString, IStringWrapper<HtmlString>
{
    ...
    {
        SanitizationInfo = SanitizationInfoBuilder.Build();
    }
    
    /// <summary>
    /// Sanitization information about the HTML string.
    /// Includes information about removed elements, attributes, styles, and CSS classes.
    /// </summary>
    public SanitizationInfo SanitizationInfo { get; }
