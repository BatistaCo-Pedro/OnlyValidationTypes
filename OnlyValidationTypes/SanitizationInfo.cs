...
public readonly partial record struct SanitizationInfo(ImmutableArray<RemovedElementInfo> RemovedElements)
{
    /// <summary>
...
/// <summary>
/// A builder for <see cref="SanitizationInfo"/>.
/// </summary>
public sealed partial class SanitizationInfoBuilder
{
    ...
    /// <summary>
    /// Builds the <see cref="SanitizationInfo"/>.
    /// </summary>
    /// <returns>A <see cref="SanitizationInfo"/> object will all the information related to the sanitization.</returns>
